...
private fun labelAndIconSectionHome(fragments: LabelIconOfHome): Pair<String?, AppIconList?> {
    return when (fragments) {
        ...
        LabelIconOfHome.INSTRUCTOR -> Pair(
            LabelIconOfHome.INSTRUCTOR.type,
            LabelIconOfHome.INSTRUCTOR.icon
        )
        LabelIconOfHome.ADMINISTRATOR -> Pair(
            LabelIconOfHome.ADMINISTRATOR.type,
            LabelIconOfHome.ADMINISTRATOR.icon
        )
        ...
        LabelIconOfHome.NOTIFICATION -> Pair(
            LabelIconOfHome.NOTIFICATION.type,
            LabelIconOfHome.NOTIFICATION.icon
        )
        LabelIconOfHome.COURSE -> Pair(LabelIconOfHome.COURSE.type, LabelIconOfHome.COURSE.icon)
        LabelIconOfHome.CHALLENGE -> Pair(
            LabelIconOfHome.CHALLENGE.type,
            LabelIconOfHome.CHALLENGE.icon
        )
